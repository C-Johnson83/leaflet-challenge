...
function spotify(shakeAndBake, secondfile) {
  ...
  let geoJSONLayer = L.geoJSON(shakeAndBake, {
  ...
  createMap(geoJSONLayer, secondfile);
}

// Function to create the map layers
function createMap(jelloJigglers, secondfile) {
  ...
  let overlayMaps = {
    ...
    "7 day Quake Spots": jello,
    "Today Quake Spots": jigglers,
  };
  ...
  let legend = L.control({ position: "bottomright", basesize: 10 });
  legend.onAdd = function(map) {
    let div = L.DomUtil.create("div", "info legend");
    let depths = [-10,1,10,20,30,40,50,60,70,80,90];
    let labels = [];
    let legendInfo = "<h3>Quake Depth <br> In Kilometers <br> Below Sea Level</h3>";
